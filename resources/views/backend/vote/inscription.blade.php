            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        ...
                        <p class="text-lead text-white">Créer un compte pour voter a un projet.</p>
                    </div>
                </div>
                    ...
                    <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                        <div class="card z-index-0">
                            ...
                            <div class="card-body">
                                ...
                                <form role="form text-left" action="{{ URL::to('/vote/projet') }}" method="POST">
                                    {{ csrf_field() }}
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <input type="contact" class="form-control" name="contact" placeholder="contact"
                                            aria-label="contact" aria-describedby="">
                                    </div>
                                    ...
                                    <div class="text-center">
                                        <button type="sublit"
                                            class="btn bg-gradient-dark w-100 my-4 mb-2">S'inscrire</button>
                                    </div>
                                </form>
                            </div>
                        </div>
